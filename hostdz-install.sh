...
###tar xvfz /etc/hostdz/libtorrent-0.13.2.tar -C /etc/hostdz/source/
...
cp /etc/hostdz/libtorrent-0.13.2.tar /etc/hostdz/source/libtorrent-0.13.2.tar
...
sudo svn checkout http://svn.code.sf.net/p/xmlrpc-c/code/stable xmlrpc-c
##sudo wget http://libtorrent.rakshasa.no/downloads/libtorrent-0.13.2.tar
tar xf libtorrent-0.13.2.tar
